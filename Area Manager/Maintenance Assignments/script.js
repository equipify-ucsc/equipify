/* ==========================================================================
   Equipify — Maintenance Assignments (Area Manager)
   Mobile navigation drawer, status filter, and technician assignment
   forms (vanilla JS, no dependencies)
   ========================================================================== */
...
(function () {
  ...
  if (refreshBtn) {
    refreshBtn.addEventListener('click', function () {
      window.showToast('Maintenance assignments refreshed.');
    });
  }
  ...
  document.querySelectorAll('.assignment-form').forEach(function (form) {
    ...
    form.addEventListener('submit', function (event) {
      ...
      window.showToast('Maintenance request assigned to ' + technicianName + '.');
    });
  });
